      ...
      content: (
        <div className="space-y-3 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-xs">
            <li>
              <strong>Server-Side AES-256-GCM Encryption:</strong> Custom provider API keys (OpenAI, Anthropic, Google) are encrypted server-side using AES-256-GCM and never stored in plaintext or browser storage.
            </li>
            <li>
              <strong>Decoupled Minimal Scopes:</strong> OAuth connections for Gmail and Google Calendar are completely optional and decoupled from your basic authentication login.
            </li>
            <li>
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Guides, agent capabilities, and FAQs for your Camail AI workspace.
          </p>
        </div>
